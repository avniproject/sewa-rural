...
export default class {
    ...
    reasonForDroppingAsPerTeacher(programEncounter, formElement) {
        ...
        statusBuilder
            .show()
            .when.addressType.equals("School")
    ...
    otherReasonAccordingToStudentParent(programEncounter, formElement) {
        ...
        statusBuilder
            .show()
            .when.valueInEncounter("Reason for dropping as per student / parent")
    ...
    otherReasonAccordingToTeacher(programEncounter, formElement) {
        ...
        statusBuilder
            .show()
            .when.valueInEncounter("Reason for dropping as per teacher")
            .containsAnswerConceptName("Other");
        return statusBuilder.build();
    }
    ...
    otherActivityPleaseSpecify(programEncounter, formElement) {
        ...
        statusBuilder
            .show()
            .when.valueInEncounter("What he/she is doing now?")
            .containsAnswerConceptName("Other");
        return statusBuilder.build();
    }
    ...
    nameOfSchool(programEncounter, formElement) {
        let statusBuilder = this._getStatusBuilder(programEncounter, formElement);
        statusBuilder.show().when.valueInEncounter("Are you ready for re-admission to school").is.yes;
        return statusBuilder.build();
    }
